...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "ss123456".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["1.gge5.com"];
pub const RS_PUB_KEY: &str = "WWkzUudeaSgdKEHYoOtV07Pv6EOwRdM7kNwgNiH5D9g=";
